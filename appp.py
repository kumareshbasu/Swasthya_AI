...
META_ACCESS_TOKEN = os.environ.get("META_ACCESS_TOKEN", "META_API_KEY")
PHONE_NUMBER_ID = os.environ.get("PHONE_NUMBER_ID", "PHONE_NUMBER_ID")
VERIFY_TOKEN = os.environ.get("VERIFY_TOKEN", "SECRET_VERIFY_TOKEN") 
